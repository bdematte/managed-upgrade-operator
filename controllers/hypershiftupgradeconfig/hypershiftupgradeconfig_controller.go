package hypershiftupgradeconfig
...
var (
	log = logf.Log.WithName("controller_hypershiftupgradeconfig")
)

// blank assignment to verify that ReconcileUpgradeConfig implements reconcile.Reconciler
var _ reconcile.Reconciler = &ReconcileHypershiftUpgradeConfig{}

// ReconcileHypershiftUpgradeConfig reconciles a HypershiftUpgradeConfig object
type ReconcileHypershiftUpgradeConfig struct {
...
func (r *ReconcileHypershiftUpgradeConfig) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling HypershiftUpgradeConfig")
	...
	case upgradev1alpha1.UpgradePhaseNew, upgradev1alpha1.UpgradePhasePending:
		...
		// Validate UpgradeConfig instance -- TODO : Check against the child cluster
...
func (r *ReconcileHypershiftUpgradeConfig) upgradeCluster(upgrader cub.ClusterUpgrader, uc *upgradev1alpha1.UpgradeConfig, logger logr.Logger) (reconcile.Result, error) {
	me := &multierror.Error{}
...
func (r *ReconcileHypershiftUpgradeConfig) SetupWithManager(mgr ctrl.Manager) error {
